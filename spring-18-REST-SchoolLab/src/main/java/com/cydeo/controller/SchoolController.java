...
public class SchoolController {
    ...
    private final StudentService serviceService;

    private final ParentService parentService;

    private final AddressService addressService;

    public SchoolController(TeacherService teacherService, StudentService serviceService, ParentService parentService, AddressService addressService) {
    ...
    public ResponseEntity<ResponseWrapper> readAllStudents(){
        return ResponseEntity.ok(new ResponseWrapper("Students are successfully retrieved",serviceService.findAll() ));
